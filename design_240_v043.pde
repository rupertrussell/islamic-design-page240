...
void parallelLines() {
  ...
  stroke(255, 0, 0);// red
  // next line
  line(saveCircleX[44], saveCircleY[44], saveCircleX[54], saveCircleY[54]);
  circle(saveCircleX[44], saveCircleY[44], 10);
  circle(saveCircleX[54], saveCircleY[54], 10);
