//xx[40] = saveCircleX[25]; // top left 
//yy[40] = saveCircleY[23]; // top left 
//xx[41] = saveCircleX[27]; // top left 
//yy[41] = saveCircleY[30]; // top left 
...
void rectangle(boolean displayConstructionLines) {
  ...
  xx[48] = saveCircleX[27]; // LEft Rectangle
  yy[48] = saveCircleY[27]; // LEft Rectangle
  xx[49] = saveCircleX[33]; // LEft Rectangle
  yy[49] = saveCircleY[33]; // LEft Rectangle
...
void step6(boolean displayConstructionLines) {
  ...
  xx[38] = x1; // top upper west lower east
  yy[38] = y1;
  xx[39] = x2;
  yy[39] = y2;
...
//yy[24] = saveCircleY[23]; // top left
//xx[25] = saveCircleX[27]; // top left
//yy[25] = saveCircleY[30]; // top left
...
//stroke(255, 0, 0); // red
//strokeWeight(3);
//circle(xx[40], yy[40], 10);
//circle(xx[41], yy[41], 10);
//stroke(0, 0, 0); // black
//strokeWeight(1);
...
// draw step11F  Parallel Lines par 4 bottom
void step11F(boolean displayConstructionLines ) {
  float x1, y1, x2, y2;
  myLineline28 = new Lineline(28, xx[50], yy[50], xx[51], yy[51], xx[46], yy[46], xx[47], yy[47], false, false, 'g', 2); // step6 top lower west and  left and bottom parallel 
  myLineline28.displayIntersection();

  myLineline29 = new Lineline(29, xx[48], yy[48], xx[49], yy[49], xx[46], yy[46], xx[47], yy[47], false, false, 'b', 2); // bottom parallel 4 left rectangle
