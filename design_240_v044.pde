...
void parallelLines() {
  ...
  //stroke(255, 0, 0);// red
  //// next line
  //line(saveCircleX[47], saveCircleY[47], saveCircleX[57], saveCircleY[57]);
  //circle(saveCircleX[47], saveCircleY[47], 10);
  //circle(saveCircleX[57], saveCircleY[57], 10);

  //stroke(0, 0, 255);// blue
  //// next line
  //  strokeWeight(4);
  //line(saveCircleX[51], saveCircleY[51], saveCircleX[59], saveCircleY[59]); // bottom
  //line(saveCircleX[49], saveCircleY[49], saveCircleX[41], saveCircleY[41]); // top
  //circle(saveCircleX[49], saveCircleY[49], 10);
  //circle(saveCircleX[41], saveCircleY[41], 10);
