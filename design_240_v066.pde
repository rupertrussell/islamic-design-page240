// xx[26]
// xx[28] top of rectangle
// xx[29]

// xx[30] // top left 
// xx[31]

// xx[32] // left of step 7
// yy[32]
// xx[33] // left of step 7
// yy[33]

// xx[34] // top left of step 8a
// yy[34]
// xx[35] // top left of step 8a
// yy[35]

// xx[36] Step6 line // top lower west upper eas
// yy[36] // top lower west upper eas
// xx[37] // top lower west upper eas
// yy[37] // top lower west upper eas
...
void parallelLines(boolean displayConstructionLines) {
  ...
  line(saveCircleX[46] - deltaX * 3, saveCircleY[46] - deltaY * 3, saveCircleX[54] + deltaX * 3, saveCircleY[54] + deltaY * 3); // Center Left // temp1

  xx[26] = saveCircleX[46] - deltaX * 3;
  yy[26] = saveCircleY[46] - deltaY * 3;

  xx[27] = saveCircleX[54] + deltaX * 3;
  yy[27] = saveCircleY[54] + deltaY * 3;
...
void step6(boolean displayConstructionLines) {
  ...
  xx[36] = -x1; // top lower west upper eas
  yy[36] = y1;
  xx[37] = -x2;
  yy[37] = y2;
